...
phase2.prototype = {
	preload: function() {
		...
		game.load.atlas('phph', 'assets/img/main/phonephase.png', 'assets/img/main/phonephase.json', Phaser.Loader.TEXTURE_ATLAS_JSON_HASH);
		game.load.atlas('lptv', 'assets/img/main/lptv.png', 'assets/img/main/lptv.json', Phaser.Loader.TEXTURE_ATLAS_JSON_HASH);
	...
	create: function() {
		...
		room = game.add.sprite(0, 0, 'phases', 'roomevening');
	...
	// ----------------------------------------------------------------
		...
		phone.animations.add('phover1', Phaser.Animation.generateFrameNames('evlock',1,4),10,false);
		phone.animations.add('phover2', Phaser.Animation.generateFrameNames('evlock',5,7),10,false);
...
// ------------------------------------------------
	...
	clickLP: function() {
		bgmusic.stop();
		game.state.start('dateProfiles2');
	},
	scroll: function() {
		scroll.alpha = 1;
