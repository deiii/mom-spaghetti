...
var content = [
	...
	"",
	"Click [1] to start." //temp text, will be more creative later
];
var line = [];
var wordIndex = 0;
var lineIndex = 0;
...
miniGameA.prototype = {
	...
	create: function() {
		...
		for(i = 0; i < 5; i++)
		{
			...
			trumpstruction = game.add.text(100, 10, 
