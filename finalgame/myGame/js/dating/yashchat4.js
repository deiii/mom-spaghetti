...
var yashchat4 = function(game) {};
yashchat4.prototype = {
    preload: function() {
        game.load.spritesheet("sprite", "assets/img/chat/league1.png", PIECE_WIDTH, PIECE_HEIGHT);
    ...
    showFinishedText: function() {
        ...
        yashheart = game.add.sprite(game.world.centerX, game.world.centerY, 'hearts', 'yashheart');
        yashheart.alpha = 0;
        yashheart.anchor.setTo(0.5, 0.5);
        game.add.tween(yashheart).to({alpha: 1}, 2000, Phaser.Easing.Linear.None, true, 1000); 
