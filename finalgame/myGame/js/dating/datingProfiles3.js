var dateProfiles3 = function(game) {};
dateProfiles3.prototype = {
	preload: function() {
	// ----------------------------------------------------------------
	...
	update: function() {
		...
		if(game.input.keyboard.isDown(Phaser.Keyboard.SPACEBAR)) {
			...
			game.sound.stopAll();
			if (((localStorage.getItem("incb3") >= 2) && 
				(localStorage.getItem("incsh3") >= 2) && 
