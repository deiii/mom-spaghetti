...
var dhanichat2 = function(game) {};
dhanichat2.prototype = {
    preload: function() {
        game.load.spritesheet("sprite", "assets/img/chat/pail.png", PIECE_WIDTH, PIECE_HEIGHT);
    ...
    showFinishedText: function() {
        ...
        dhanheart = game.add.sprite(game.world.centerX, game.world.centerY, 'hearts', 'dhaniheart');
        dhanheart.alpha = 0;
        dhanheart.anchor.setTo(0.5, 0.5);
        game.add.tween(dhanheart).to({alpha: 1}, 2000, Phaser.Easing.Linear.None, true, 1000); 
