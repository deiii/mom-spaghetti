...
var alexchat4 = function(game) {};
alexchat4.prototype = {
    preload: function() {
        game.load.spritesheet("sprite", "assets/img/chat/ball.png", PIECE_WIDTH, PIECE_HEIGHT);
    ...
    showFinishedText: function() {
        ...
        alexheart = game.add.sprite(game.world.centerX, game.world.centerY, 'hearts', 'alexheart');
        alexheart.alpha = 0;
        alexheart.anchor.setTo(0.5, 0.5);
        game.add.tween(alexheart).to({alpha: 1}, 2000, Phaser.Easing.Linear.None, true, 1000); 
