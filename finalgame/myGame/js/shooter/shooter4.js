...
var shooter4 = function(game) {};
shooter4.prototype = {
	preload: function() {
	    game.load.image('space', 'assets/img/shooter/starfield.png');
	...
	create: function() {
	    ...
	    starfield = game.add.tileSprite(200, 0, 1600, 1600, 'space');
	...
	update: function() {
	    ...
	    if (game.input.keyboard.isDown(Phaser.Keyboard.SPACEBAR)) {
		    if (score >= 500)
				{
					...
					localStorage.setItem("incsh4", incsh4);
		    ...
		    if ((localStorage.getItem("incsh4") >= 1) && 
