...
var shooter2 = function(game) {};
shooter2.prototype = {
	preload: function() {
	    game.load.image('space', 'assets/img/shooter/fried1.png');
	...
	update: function() {
	    ...
	    if (game.input.keyboard.isDown(Phaser.Keyboard.SPACEBAR)) {
	    	if (score >= 500)
			{
				...
				localStorage.setItem("incsh2", incsh2);
		    ...
		    if ((localStorage.getItem("incsh2") >= 2) && 
					(localStorage.getItem("incsh2") >= 2) && 
					(localStorage.getItem("incsh2") >= 1) &&
