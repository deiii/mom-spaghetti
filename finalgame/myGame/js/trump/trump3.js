...
trump3.prototype = {
	...
	create: function() {
		...
		murica = game.add.sprite(0,0, 'trumptings', 'murica3');
		...
		for(i = 0; i < 10; i++)
		{
			...
			trump = game.add.sprite(0, 0,'trumptings', 'trumpface3');
	...
	updateCounter: function() {
		...
		if(counter == 70)
		{
			if (score >= 200)
			{
				...
				localStorage.setItem("inctr3", inctr3);
			}
