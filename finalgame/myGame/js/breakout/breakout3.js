...
breakout3.prototype = {
	...
	update: function() {
		...
		game.physics.arcade.collide(ball4, phottom, this.hitFloor4, null, this);
		...
		if(game.input.keyboard.isDown(Phaser.Keyboard.SPACEBAR)) {
			...
			{
				incb3 += 1;
				localStorage.setItem("incb3", incb3);	
			}
	...
	hitFloor: function(ball) {
		...
		game.state.start('bogameover3');
		score = 0;
	},


	hitFloor2: function(ball) {
		ball.kill();
		ball2.kill();
