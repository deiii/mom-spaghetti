...
phase4.prototype = {
	preload: function() {
		...
		game.load.audio('bgmusic', ['assets/audio/main/slowlounge.mp3', 'assets/audio/main/slowlounge.ogg']);
	...
	create: function() {
		...
		room = game.add.sprite(0, 0, 'phases', 'roombloodmoon');
	...
	// ----------------------------------------------------------------
		...
		phone.animations.add('phover1', Phaser.Animation.generateFrameNames('bmlock',1,4),10,false);
		phone.animations.add('phover2', Phaser.Animation.generateFrameNames('bmlock',5,7),10,false);
...
// ------------------------------------------------
	...
	clickLP: function() {
		bgmusic.stop();
		game.state.start('dateProfiles4');
	},
	scroll: function() {
		scroll.alpha = 1;
